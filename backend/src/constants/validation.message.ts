interface IValidationErrorMessages {
  ...
  readonly VALID_ROLES_ENUM: string;
  readonly VALID_SOURCE_ENUM: string;
}
...
const validationMessages: Record<string, IValidationErrorMessages> = {
  EN: {
    ...
    VALID_ROLES_ENUM: 'Role should be either apache or nginx or all.',
    VALID_SOURCE_ENUM: 'Source should be either apache or nginx or all.',
  },
};
